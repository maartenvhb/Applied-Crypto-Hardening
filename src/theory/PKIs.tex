...
Transparency~\cite{certtransparency}. In addition, RFC 6844 describes DNS Certification Authority Authorization (CAA) Resource Records, a mechanism for domain name owners to signal which Certificate Authorities are authorized to issue certificates for their domain.
...
\subsection{Certification Authority Authorization Resource Records}
\label{sec:caarecords}

RFC 6844 describes DNS Certification Authority Authorization (CAA) Resource Records, a mechanism for domain name owners to signal which Certificate Authorities are authorized to issue certificates for their domain.
